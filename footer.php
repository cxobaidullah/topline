        ...
        <div class="widget dark">
          ...
          <div class="opening-hourse">
            <ul class="list-border">
              ...
              <li class="clearfix">
                <span> Sat - Sun : </span>
                <div class="value pull-right"> Off </div>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-5">
          <p class="font-11 text-black-777 m-0 copy-right">Copyright: <?php echo date('Y')?> <a href="index.php"><span class="color_red">Topline Property</span></a>. All Rights Reserved</p>
        </div>
