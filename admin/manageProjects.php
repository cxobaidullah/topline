...
if (isset($_GET['id']) && $_GET['id'] != '') {
	...
	$res = mysqli_query($con, "select * from projects where property_id ='$id'");
...
if (isset($_POST['submit'])) {
	...
	if ($msg == '') {
		if (isset($_GET['id']) && $_GET['id'] != '') {
			...
			move_uploaded_file($_FILES['image5']['tmp_name'], './media/product/' . $image5);
			move_uploaded_file($_FILES['image6']['tmp_name'], './media/product/' . $image6);
			mysqli_query($con, "insert into projects(`property_title`, `property_details`, `price`,`sqaure_feet`, `city`, `property_address`, `property_img`, `img2`, `img3`, `img4`, `img5`, `img6`, `parking`, `utility`, `agent_id`, `property_status`, `nearby_resturant`, `cctv`, `water_supply`, `sewerage`, `internet`, `nearby_school`, `nearby_hospital`, `nearby_mall`, `nearby_transpoart`, `security_staff`,`status`) 
			values('$property_title','$property_details','$price','$sqaure_feet','$city','$property_address','$image','$image2','$image3','$image4','$image5','$image6',
			'$parking','$utility','$agent_id','$property_status','$nearby_resturant','$cctv','$water_supply','$sewerage','$internet','$nearby_school','$nearby_hospital','$nearby_mall','$nearby_transpoart','$security_staff','$status')");
		}
						...
						<div class="card-body card-block">
							...
							<div class="row">
								...
								<div class="col-lg-4">
									<div class="form-group">
										<label for="projects" class=" form-control-label">Property Title</label>
								...
								<div class="col-lg-4">
									<div class="form-group">
										<label for="projects" class=" form-control-label">Property Status</label>
								...
								<div class="col-lg-4">
									...
									<div class="form-group">
										<label for="projects" class=" form-control-label">Price</label>
								...
								<div class="col-lg-4">
									...
									<div class="form-group">
										<label for="projects" class=" form-control-label">Square Feet</label>
							...
							<div class="row">
								<div class="col-lg-6">
									...
									<!-- //img1 -->
									<div class="form-group">
										<label for="projects" class=" form-control-label">Image 1</label>
								...
								<div class="col-lg-6">
									...
									<!-- image2 -->
									<div class="form-group">
										<label for="projects" class=" form-control-label">Image 2</label>
								...
								<div class="col-lg-6">
									<!-- //image3 -->
									<div class="form-group">
										<label for="projects" class=" form-control-label">Image 3</label>
								...
								<div class="col-lg-6">
									...
									<!-- image4 -->
									<div class="form-group">
										<label for="projects" class=" form-control-label">Image 4</label>
								...
								<div class="col-lg-6">
									...
									<!-- image4 -->
									<div class="form-group">
										<label for="projects" class=" form-control-label">Image 5</label>
								...
								<div class="col-lg-6">
									...
									<!-- image4 -->
									<div class="form-group">
										<label for="projects" class=" form-control-label">Image 6</label>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										<label for="projects" class=" form-control-label">City</label>
										<input type="text" class="form-control" name="city" placeholder="City" value="<?php echo $city?>">
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
										<label for="projects" class=" form-control-label">Property Address</label>
							...
							<div class="row">
								...
								<div class="col-lg-4">
									<div class="form-group">
										<label for="projects" class=" form-control-label">Sewerage</label>
							...
							<div class="row">
								<div class="col-lg-3">
									...
									<div class="form-group">
										<label for="projects" class=" form-control-label">Nearby Resturant</label>
								...
								<div class="col-lg-3">
									...
									<div class="form-group">
										<label for="projects" class=" form-control-label">Nearby School</label>
								...
								<div class="col-lg-3">
									...
									<div class="form-group">
										<label for="projects" class=" form-control-label">Nearby Hospital</label>
								...
								<div class="col-lg-3">
									...
									<div class="form-group">
										<label for="projects" class=" form-control-label">Nearby Shopping Mall</label>
								...
								<div class="col-lg-3">
									...
									<div class="form-group">
										<label for="projects" class=" form-control-label">Nearby Public Transpoart</label>
							...
							<div class="row">
								<div class="col-lg-3">
									...
									<div class="form-group">
										<label for="projects" class=" form-control-label">Security</label>
								...
								<div class="col-lg-3">
									...
									<div class="form-group">
										<label for="projects" class=" form-control-label">CCTV</label>
								...
								<div class="col-lg-3">
									...
									<div class="form-group">
										<label for="projects" class=" form-control-label">Internet</label>
								...
								<div class="col-lg-3">
									...
									<div class="form-group">
										<label for="projects" class=" form-control-label">Security Staff</label>
