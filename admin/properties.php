...
if(isset($_GET['type']) && $_GET['type']!=''){
	...
	if($type=='status'){
		...
		$update_availablility_sql="update properties set status='$availablility' where property_id='$id'";
...
on properties.agent_id=agent.agent_id order by properties.property_id desc";
                  ...
                  <div class="col-xl-12">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <div>
                              <a href="manage_properties.php" class="btn btn-primary btn-right">Add Properties</a>
                           </div>
                        </div>
                        <div class="card-body--">
